...
## 📊 Tabela de Sistemas e Características Técnicas
...
| **Linux/Windows** | Linux Ubuntu 24.04 | Linux Ubuntu 24.04 | Docker (Multiplataforma) | Linux Ubuntu 24.04 | Docker (Multiplataforma) |
| **Front-end** | Tailwind e Livewire | Filament (Laravel) | Node.js 20 + React 19 + Vite 7 + Bootstrap 5 | jQuery e JS vanilla | *N/A (API)* |
| **Repositório** | [Estatuinte](https://github.com/QintessUesc/Estatuinte) | [Avaliação Setorial](https://github.com/QintessUesc/AvaliacaoSetorial) | [Sistema de Concursos](https://github.com/QintessUesc/SistemaConcurso) | [GLPI](https://github.com/QintessUesc/GLPI) | [Uesc_API](https://github.com/QintessUesc/UescAPI) |
